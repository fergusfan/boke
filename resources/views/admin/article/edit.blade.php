  ...
  <div class="body-content">
    <form method="post" id="form" class="form-x" action="{{url('admin/article/'.$article['id'])}}">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="{{$article['title']}}" name="title" datatype="s5-30"/>
          <div class="tips"></div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="keywords" value="{{$article['keywords']}}"datatype="s2-10"/>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="author" value="{{$article['author']}}"  datatype="s2-10"/>
          <div class="tips"></div>
        </div>
      </div>
        ...
        <!--dom结构部分-->
          <div id="uploader-demo">
            ...
            <div id="filePicker">选择图片</div>
              {{--在页面指定位置将图片显示出来--}}
              <img  id="img" style="position: absolute;margin-left:200px;margin-top:-50px;width: 200px;height: 100px" src="/{{$article['img_url']}}">
        ...
        <div class="form-group">
          ...
          <div class="field">
            <select name="cat_id" class="input w50">
              ...
              @foreach($cats as $cat)
                  {{--判断如果分类表的id等于文章表中分类id，则让分类处于被选中状态selected--}}
      ...
      <div class="form-group"style="display: none">
        ...
        <div class="field">
          <textarea name="content" id="text" class="input" style="height:450px; border:1px solid #ddd;">
      ...
      <div style="margin-left: 130px;width: 85%" id="editor">
        <p> {!!$article['content']!!}</p>{{--内容为html标签，在两头加上！！后不会被转义，原样输出--}}
      </div>
      <br><br>
